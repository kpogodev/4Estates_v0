          ...
          <form className='form flex flex-col items-start gap-4 w-full' onSubmit={onSubmit}>
            <div className='form-control w-full'>
              ...
              <label className='input-group input-group-lg'>
                <span>
                  <MdAlternateEmail className={`transition ${emailFocused && 'text-info'} ${emailValid && 'text-success'} ${emailValid === false && 'text-error'}`} />
                </span>
                <input
                  type='email'
                  placeholder='name@domain.com'
                  className={`input input-bordered w-full ${emailValid && 'input-success'} ${emailValid === false && 'input-error'}`}
                  value={email}
            ...
            <button type='submit' className='btn btn-primary text-lg mt-4 flex gap-2 items-center' disabled={email === '' || isLoading ? true : false}>
